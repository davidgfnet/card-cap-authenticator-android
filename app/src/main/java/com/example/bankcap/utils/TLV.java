...
public class TLV {
    ...
    private SparseArray<byte[]> tlist;
    ...
    public byte[] get(int tagn) {
        return tlist.get(tagn, new byte[0]);
    }
    ...
    public static byte[] createDOL(byte[] cdol1, int stage, int challenge) {
        ...
        SparseArray<byte[]> overr = new SparseArray<>();
